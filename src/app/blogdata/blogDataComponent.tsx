...
export default function BlogDataComponent(){
    // 建立轉跳
    ...
    // 排序
    const [sortMethod, setSortMethod] = useState<["title"|"editTime","asc"|"desc"]>(["editTime","desc"])
        ...
        <main className={Style.main}>
            ...
            <search className={Style.searchDiv}>
                <div className={Style.searchBox} >
                    ...
                    <button type="button" onClick={()=>{setSearchStart(true)}} >查詢</button>
                </div>
